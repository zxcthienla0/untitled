export const GiftInfo = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 lg:px-2 lg:pt-24 xl:mb-50">
      <div className="flex max-xl:flex-col lg:justify-between lg:items-center flex-row gap-3 xl:gap-12">
        ...
        <div className="relative xl:w-[59%] max-xl:border-4 border-[#C3937C]">
          <img
            ...
            className="w-full h-auto xl:rounded-bl-[170px] object-cover object-center"
          />
